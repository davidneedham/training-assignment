...
## Important Data
 ...
 - Feedback surveys and customers interviews report that:
    ...
    - Installing Lando is a barrier for some people and may require it's own lesson. _(Sam suspects this is responsible for the low completion rate.)_
...
**Galadriel** | Jack-of-all-trades with special interest in Kubernetes and data analysis. They see connections between different moving parts that others overlook. |
...
--- | --- | --- |
**David** | Make improvements to the existing lesson (which he created). Work with Arwin, Pippin, and Sam to create outlines for courses and set goals. Approve and publish completed lessons. | Meet with SME to better understand Katacoda and how a project like this could be built there. Think about how to improve the completion rate. |
**Arwin** | Outline Drupal and WordPress lessons for the quarter. Complete 2 lessons for Drupal. Provide direction and mentorship to Pippin and Sam. | Complete additional lessons. Review other completed lessons. |
...
### August
#### Summary
As time goes on the plan get fuzzier and needs to be revised. Sam (who enjoys data analysis) assists David with observations in data for July and the team meets to revise their plans for the month. Arwin completes the Drupal course and leads Pippin and Sam towards completing their topics that are complimentary to his own. Galadriel continues to provide peer review while recording introductions and supplemental material for completed lessons.

#### Details
| | Priorities | Stretch goals |
--- | --- | --- |
**David** | Work with Sam to review data from the previous month. Meet with the team and revise this plan. Unblock team members with support and SMEs. Begin working with Marketing to promote and launch new lessons. Start planning for Q4. | Mentor Arwin as they learn to lead Pippin and Sam. Review all completed lessons for consistency and quality control. |
**Arwin** | Complete all remaining lessons in the Lando+Drupal course.  Provide direction and mentorship to Pippin and Sam. | Review Pippin and Sam's work to ensure consistant and clear integration with his lessons. Begin WordPress lessons. |
...
### September
#### Summary
There's a lot of wiggle room in the final month of the quarter to allow for unexpected delays, life events, and changes in priorities. Sam and David reviews observations in data for August and the team meets to revise their plans for the month. Arwin completes a lesson (or more) for Lando+WordPress. Pippin and Sam complete their projects and assist other team members with QA, going back to revise their publishes lessions with observations from the previous 30 days. Galadriel completes all video assets
